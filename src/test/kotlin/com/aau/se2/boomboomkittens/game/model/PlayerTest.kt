...
class PlayerTest {
    ...
    fun `player starts alive and has defuse`(){
        val player = Player (playerId = UUID.randomUUID(), name = "Player1", defuseCount = 1, isAlive = true)
    ...
    fun `useDefuseCard decreases count`(){
        val player = Player (playerId = UUID.randomUUID(), name = "Player2", defuseCount = 2, isAlive = true)
    ...
    fun `useDefuseCard fails when none available`(){
        val player = Player (playerId = UUID.randomUUID(), name = "Player3", defuseCount = 0, isAlive = true)
    ...
    fun `hasDefuseCard fails when none available`(){
        val player = Player (playerId = UUID.randomUUID(), name = "Player4", defuseCount = 0, isAlive = true)
    ...
    fun `addDefuseCard increases count`(){
        val player = Player (playerId = UUID.randomUUID(), name = "Player5", defuseCount = 0, isAlive = true)
